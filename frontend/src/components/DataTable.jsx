  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center justify-center py-8 space-y-2">
        <ApiStatusIndicator isError={true} error={error} />
        ...
        <div className="flex items-center space-x-2">
          <div className="relative">
            ...
            <Input
              ...
              value={searchColumn ? (table.getColumn(searchColumn)?.getFilterValue() ?? "") : ""}
              onChange={(event) =>
          ...
          <ApiStatusIndicator isLoading={isLoading} isError={isError} error={error} />
        </div>
